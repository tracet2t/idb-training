...
export default function Analytics() {
  ...
  const updateRule = (id: number, field: keyof FilterRule, value: string | boolean) => {
        ...
        <main className="flex-1 overflow-y-auto p-6 pt-4">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Build complex queries to segment and analyze participant data.
            </p>
          </div>
              ...
              {rules.map((rule) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      checked={rule.not}
                      onCheckedChange={(checked) => updateRule(rule.id, 'not', checked as boolean)}
                    />
